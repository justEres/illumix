...
use egui::{Button, Frame, Margin, Rect, Ui};
...
impl FixtureManager {
    ...
    pub fn show(&mut self, ctx: &egui::Context) {
        egui::Window::new("Fixture Manager")
            .resizable(true)
            .show(ctx, |ui| {
                                    ...
                                    if fixture.fixture_length == None {
                                        ...
                                        if fixture.fixture_start.unwrap() == i {
                                            self.draw_frame(
                                                ...
                                                ui,
                                                Vec2 {
                                                    x: ((50 * length_of_fixture)
                                                        + ((length_of_fixture - 1) * 5))
                                                        as f32,
                                                    y: 50.,
                                                },
                                                Vec2 {
    ...
    fn draw_button(&self, name: String, ui: &mut Ui, size: Vec2, offset: Vec2) {
        let widget_rect = Rect::from_min_size(ui.min_rect().min + offset, size);
